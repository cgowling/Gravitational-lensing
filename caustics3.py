...
e= 0
Ds = (1600/h)*1e6*pc   # metres distance to source 878 original
...
for xp in range(-Nhalf,Nhalf):
    ...
    for yp in range(-Nhalf,Nhalf): 
        ...
        if nblobs >= 4:
            caustics[xp-Nhalf,yp -Nhalf]= 5
        elif 2<=nblobs<=3:
            caustics[xp-Nhalf,yp -Nhalf]= 3
        elif nblobs<2:
            caustics[xp-Nhalf,yp -Nhalf]= 1
